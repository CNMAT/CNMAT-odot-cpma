...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 75.0, 150.0, 24.0 ],
					"saved_bundle_data" : [  ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 435.0, 90.0, 112.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 390.0, 150.0, 68.0, 22.0 ],
					"style" : "",
					"text" : "o.pack /wb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "" ],
					"patching_rect" : [ 255.0, 150.0, 109.0, 22.0 ],
					"style" : "",
					"text" : "o.random /random"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 255.0, 315.0, 218.0, 64.0 ],
					"text" : "/dur/ms = 100,\n/buffer = \"wb\",\n/start/phase += (/random * 0.01),\ndelete(/random)",
