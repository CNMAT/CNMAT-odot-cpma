...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 810.0, 255.0, 55.0, 22.0 ],
					"style" : "",
					"text" : "set wb 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 810.0, 225.0, 55.0, 22.0 ],
					"style" : "",
					"text" : "set wb 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 510.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 630.0, 381.0, 256.0, 64.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 375.0, 60.0, 130.0, 130.0 ],
					"range" : [ 0.0, 1.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 683.0, 144.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "replace"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 683.0, 180.0, 182.0, 22.0 ],
					"style" : "",
					"text" : "buffer~ wb WOMBLITZ.wav -1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "float", "float", "float", "float", "list", "" ],
					"patching_rect" : [ 630.0, 315.0, 256.0, 64.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 630.0, 283.0, 90.0, 22.0 ],
					"style" : "",
					"text" : "normalize 0.95"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 150.0, 420.0, 123.0, 105.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 754.0, 662.0, 61.0, 22.0 ],
									"style" : "",
									"text" : "mute 1, 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "FullPacket" ],
									"patching_rect" : [ 210.0, 395.0, 204.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "FullPacket", "FullPacket" ],
									"patching_rect" : [ 210.0, 300.0, 449.0, 59.0 ],
									"text" : "/linelist = if(\n  /reverse == 0, [/offset/ms, 0., /offset/ms + /duration/ms, /duration/ms], [/offset/ms + /duration/ms, 0., /offset/ms, /duration/ms])",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 546.25, 395.0, 51.5, 22.0 ],
									"style" : "",
									"text" : "t 1 b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "" ],
									"patching_rect" : [ 196.5, 259.0, 32.5, 22.0 ],
									"style" : "",
									"text" : "t 1 l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 578.75, 469.0, 52.25, 22.0 ],
									"style" : "",
									"text" : "f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 271.666656, 427.0, 74.0, 22.0 ],
									"style" : "",
									"text" : "prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 777.0, 749.0, 78.0, 22.0 ],
									"style" : "",
									"text" : "buffer~ nada"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 754.0, 623.0, 60.0, 22.0 ],
									"style" : "",
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 578.75, 749.0, 58.0, 22.0 ],
									"style" : "",
									"text" : "thispoly~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 206.25, 665.5, 42.0, 22.0 ],
									"style" : "",
									"text" : "*~ 0.2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 578.0, 550.0, 33.0, 22.0 ],
									"style" : "",
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 578.0, 496.0, 33.0, 22.0 ],
									"style" : "",
									"text" : "- 10"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 578.0, 523.0, 53.0, 22.0 ],
									"style" : "",
									"text" : "delay 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 206.25, 635.5, 168.0, 22.0 ],
									"style" : "",
									"text" : "*~ 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "signal", "signal", "", "" ],
									"patching_rect" : [ 578.75, 579.0, 175.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 210.0, 427.0, 36.0, 22.0 ],
									"style" : "",
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 337.0, 203.0, 25.0, 25.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 206.25, 749.0, 25.0, 25.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 210.0, 469.0, 70.0, 22.0 ],
									"style" : "",
									"text" : "play~ nada"
								}
...
,
					"patching_rect" : [ 465.0, 570.0, 99.0, 22.0 ],
